...
def main():
    ...
    vault = project.vault.deploy(compass, weth, initial_c_asset, router, refund_wallet, entrance_fee, service_fee_collector, service_fee, redemption_fee, redemption_fee_collector, sender=acct, **kw)
